...
# Build gg
RUN make -j14 -f Makefile-ggauth70.mk
RUN make -j14 -f Makefile-ggsrvlib.mk
 
# BUild Smart
RUN make -j14 -f Makefile-smart.mk
 
# Build Game Server
RUN make -j14 -f Makefile-gs.mk
 
# Build Auth Server
RUN make -j14 -f Makefile-as.mk
 
# Build Login Server
RUN make -j14 -f Makefile-ls.mk
 
# Build Message Server
RUN make -j14 -f Makefile-ms.mk
 
# Build Rank Server
RUN make -j14 -f Makefile-rs.mk
